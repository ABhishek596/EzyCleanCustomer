...
export const baseURL = 'http://ezyclean.theprojecttest.xyz/api/'
export const http2 = 'http://ezyclean.theprojecttest.xyz/'

export const http1 = axios.create({
	baseURL: 'http://ezyclean.theprojecttest.xyz/',
	timeout: 100000,
	headers: {
...
const http = axios.create({
	baseURL: 'http://ezyclean.theprojecttest.xyz/api/',
	timeout: 100000,
	headers: {
		'Content-Type': 'application/json',
		Accept: 'application/json',
