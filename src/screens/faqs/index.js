...
const Faqs = ({ loading, GetPrivacyPolicy, privacyPolicy }) => {
    // useEffect(() => {
    //     GetPrivacyPolicy()
    // }, [])
                    ...
                    <View style={globalStyles.center}>
                        ...
                        <ScrollView showsVerticalScrollIndicator={false}>
                            ...
                            <View style={{ alignSelf: 'center', width: SIZES.width * .9, marginTop: SIZES.height * .03, }}>
                                ...
                                <Text style={{ color: COLORS.secondary, fontWeight: 'bold', fontSize: SIZES.width * .058, marginVertical: SIZES.height * .02, }}>FAQs Dryfi Laundry</Text>
                                ...
                                {/* <Text style={{ color: COLORS.secondary, fontWeight: 'bold', fontSize: SIZES.width * .058, marginVertical: SIZES.height * .02, }}>{''}</Text> */}
                                    ...
                                    <Text style={{ color: COLORS.secondary,marginTop:10 }}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</Text>
