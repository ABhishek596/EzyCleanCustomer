  ...
  const handleConfimOrder = () => {
    ...
    addonsList.map(item => {
      ...
      temArr.push({
        ...
        shipping_price: item?.dataAddon?.delivery?.urgent_charge ? item?.dataAddon?.delivery?.urgent_charge : null,
        shipping_name: item?.dataAddon?.delivery?.type ? item?.dataAddon?.delivery?.type : null,
        color1: item?.dataAddon?.color1.id ? item?.dataAddon?.color1.id : null,              //update letter
        // color2: item?.dataAddon?.color2?.id,
        packing_id: item?.dataAddon?.packing_id?.id ? item?.dataAddon?.packing_id?.id : null,
        addon_id: item?.dataAddon?.addon_id?.id ?  item?.dataAddon?.addon_id?.id : null,
        damage_id: item?.dataAddon?.damage_id?.id ? item?.dataAddon?.damage_id?.id : null,
        stain_id: item?.dataAddon?.stain_id?.id ? item?.dataAddon?.stain_id?.id : null,
        service_id: item?.service_id ? item?.service_id : null,
        category_id: item?.category_id ? item?.category_id : null,
        iron: item?.dataAddon?.iron?.id ? item?.dataAddon?.iron?.id : null,
        quantity: item?.qty ? item?.qty : '0',
        price: item?.amount ? item?.amount : null,
        product_name: item?.product_name ? item?.product_name : null,
        service_name: csIds?.serviceId?.service_name ? csIds?.serviceId?.service_name : null,    //update letter
        color1_name: item?.dataAddon?.color1,
        // color2_name: item?.dataAddon?.color2?.color_name,
        packing_name: item?.dataAddon?.packing_id?.packing_style ? item?.dataAddon?.packing_id?.packing_style : null,
        addon_name: item?.dataAddon?.addon_id?.addon_name ? item?.dataAddon?.addon_id?.addon_name : null,
        damage_name: item?.dataAddon?.damage_id?.damage ? item?.dataAddon?.damage_id?.damage : null,
        stain_name: item?.dataAddon?.stain_id?.stains ? item?.dataAddon?.stain_id?.stains : null,
        iron_price: '0',
        packing_price: item?.dataAddon?.packing_id?.price ? item?.dataAddon?.packing_id?.price : null,
        addon_price: item?.dataAddon?.addon_id?.price ? item?.dataAddon?.addon_id?.price : null,
        barcode: '72614453',
      });
      totalQty += 1;
    });
